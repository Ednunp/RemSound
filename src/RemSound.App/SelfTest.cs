...
internal static partial class SelfTest
{
    ...
    public static int Run(string[] args)
    {
        ...
        RunStep(results, "AUDIT: a deselected or switched ASIO driver gets the full interactive close time", AuditAsioDriverReleaseIsNotRushed);
        RunStep(results, "AUDIT: a stream coming back late after a wake cannot undo a raise (all three configurations)", AuditLateStreamAfterWakeKeepsARaise);
        ...
        RunStep(results, "AUDIT: installing RemSound points the service at the installed copy", AuditServiceFollowsTheInstalledCopy);
        RunStep(results, "AUDIT: uninstalling offers to remove the DAW plugin and the service", AuditUninstallOffersThePluginAndTheService);
        RunStep(results, "AUDIT: the installed DAW plugin follows the app, and removing it stays inside its own folder", AuditInstalledPluginFollowsTheApp);
